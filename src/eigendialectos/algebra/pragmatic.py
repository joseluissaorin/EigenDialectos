"""Pragmatic operator for dialect transformation analysis.

Specialised for discourse markers, politeness strategies, hedging
patterns, and conversational-level variation across dialects.
"""
...
class PragmaticOperator:
    """Operator for pragmatic variation subspace identification."""
    ...
    def identify_subspace(
        ...
        """Identify the subspace where pragmatic changes dominate.

        Uses known pragmatic contrast pairs -- discourse markers
        (vale->dale, oye->mira), politeness particles, hedging
        expressions -- to extract the principal pragmatic variation
        directions.
        ...
        word_pairs : list[tuple[str, str]]
            Pragmatic contrast pairs (reference_form, target_form).
    ...
    def extract_component(
        ...
        """Extract the pragmatic component of a transformation.

        Projects (W - I) onto the pragmatic subspace.
    ...
    @staticmethod
    def pragmatic_distance(
        W_a: TransformationMatrix,
        W_b: TransformationMatrix,
        subspace: np.ndarray,
    ) -> float:
        """Compute the pragmatic distance between two transformations.
        ...
        -------
        float
            Frobenius distance between pragmatic components.
        """
        comp_a = PragmaticOperator.extract_component(W_a, subspace)
        comp_b = PragmaticOperator.extract_component(W_b, subspace)
